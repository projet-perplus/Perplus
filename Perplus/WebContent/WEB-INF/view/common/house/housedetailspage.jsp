	...
	<div class="row" id="slider-thumbs" style="margin-top: 10px;">
		...
		<ul>
			<li><a class="thumbnail" id="carousel-selector-0"> <img
					src="http://placehold.it/170x100&text=one">
			</a></li>
			<li><a class="thumbnail" id="carousel-selector-1"> <img
					src="http://placehold.it/170x100&text=two">
			</a></li>
			<li><a class="thumbnail" id="carousel-selector-2"> <img
					src="http://placehold.it/170x100&text=three">
			</a></li>
			<li><a class="thumbnail" id="carousel-selector-3"> <img
					src="http://placehold.it/170x100&text=four">
			</a></li>
			<li><a class="thumbnail" id="carousel-selector-4"> <img
					src="http://placehold.it/170x100&text=five">
			</a></li>
		</ul>
	</div>
	<!-- /slider-thumbs -->
		...
		<div class="col-md-9 col-sm-8">
			...
			<div class="col-md-9">
				<div class="row row-maginTB">
					...
					<div class="col-md-7 panel-MT">request</div>
				</div>
				<div class="row">
				...
				<div class="row row-condensed space-4">
					<div class="col-md-8 col-md-offset-1">후기리스트</div>
				</div>
			</div>
			<!-- /숙소 상세 페이지 메뉴 끝 -->
