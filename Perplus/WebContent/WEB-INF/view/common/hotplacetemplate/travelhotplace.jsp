				...
				<ul class="dropdown-menu " style="min-width: 90px !important;">
					<li style="padding-left: 23%; margin-top: 10px"><label
						class="checkbox-inline"><input type="checkbox"
							name="maker_filter" value="food">음식</label> <!-- 						<a href="#" data-toggle="modal" data-target="#reviewEnrollment"> -->
						<!-- 							<button type="button" class="btn btn-primary">리뷰 작성</button> -->
						<!-- 						</a> --></li>
					<li style="padding-left: 23%; margin-bottom: 10px;"><label
						class="checkbox-inline"><input type="checkbox"
							name="maker_filter" value="hot">명소</label> <%-- 						<a href="${initParam.rootPath}/review/showReview.do?reviewSerial=26">   <!-- reviewSerial은 requestScope의 리뷰시리얼값~~ --> --%>
