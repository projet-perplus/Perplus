...
<ul class="submenu_ul" data-main="accountmanagement">
	...
	<li data-sub="payment_method.do"><a href="${initParam.rootPath}/payment_method.do">결제 수단</a><br></li>
	<li data-sub="payout_preference.do"><a href="${initParam.rootPath}/member/howgetmoneyfind.do">대금수령 방법</a><br></li>
