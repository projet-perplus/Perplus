...
public class HouseVo implements Serializable{
	...
	public HouseVo(int houseSerial,String memberEmail){
	...
	public String toString() {
		return "HouseVo [houseSerial=" + houseSerial + ", memberEmail=" + memberEmail + ", houseTitle=" + houseTitle
				+ ", houseContent=" + houseContent + ", houseNecessaryCondition=" + houseNecessaryCondition
				+ ", checkinStart=" + checkinStart + ", checkinEnd=" + checkinEnd + ", houseRating=" + houseRating
